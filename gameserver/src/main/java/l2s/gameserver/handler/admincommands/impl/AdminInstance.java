...
public class AdminInstance implements IAdminCommandHandler
{
    ...
    replyMSG.append("<center><edit var=\"name\" width=130 height=10 length=10><br><br></center>");
    replyMSG.append("<button value=\"Remove Instance\" action=\"bypass -h admin_reset_reuse $name\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\">");
