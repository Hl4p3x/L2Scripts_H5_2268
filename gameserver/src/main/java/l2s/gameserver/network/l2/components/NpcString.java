...
public enum NpcString
{
    ...
    // Text: Ah ah... From the Magic Force,  no more... I will be freed
    AH_AH_FROM_THE_MAGIC_FORCE_NO_MORE_I_WILL_BE_FREED(1800874),
    // Text: Even the Magic Force  binds you, you  will never be forgiven...
	...
	// Text: This place is dangerous, $s1. Please turn back.
	UGH_I_HAVE_BUTTERFLIES_IN_MY_STOMACH(1800082),
	...
	FANTASY_ISLE_IS_FULLY_COMMITTED_TO_YOUR_HAPPINESS(1800085),
	//Text: Fantasy Isle is fully committed to your happiness.
	NOW_ID_LIKE_TO_INTRODUCE_THE_MOST_BEAUTIFUL_SINGER_IN_ADEN(1800086),	
	...
	JUST_BACK_FROM_THEIR_WORLD_TOURPUT_YOUR_HANDS_TOGETHER_FOR_THE_FANTASY_ISLE_CIRCUS(1800090),
	//Text: Just back from their world tourРІР‚В¦put your hands together for the Fantasy Isle Circus!
	COME_ON__EVERYONE(1800091),
	...
	OH__(1800095),
	//Text: ;;;;;;Oh
	OKAY_NOW_HERE_COMES_THE_NEXT_PERSON(1800096),
	...
	NOW_THIS_IS_THE_END_OF_TODAYS_SHOW(1800100),
	...
	WELL_I_WISH_I_COULD_CONTINUE_ALL_NIGHT_LONG_BUT_THIS_IS_IT_FOR_TODAY(1800103),
