...
public class RelationChangedPacket extends L2GameServerPacket
{
	...
	protected RelationChangedPacket(int s)
	{
	...
	public static L2GameServerPacket update(Player sendTo, Playable targetPlayable, Player activeChar)
	{
		...
		RelationChangedPacket pkt = new RelationChangedPacket(1);
	...
	public static L2GameServerPacket setR(Player sendTo, Playable targetPlayable, Player activeChar, int relationtst)
	{
		if(sendTo == null || targetPlayable == null || activeChar == null)
			return null;
