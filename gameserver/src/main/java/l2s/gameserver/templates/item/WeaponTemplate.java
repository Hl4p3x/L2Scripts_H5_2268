...
public final class WeaponTemplate extends ItemTemplate
{
	...
	{
		NONE(1, "Shield", Stats.SWORD_WPN_VULNERABILITY),
		...
		ETC(7, "Etc", Stats.SWORD_WPN_VULNERABILITY),
		...
		ROD(13, "Rod", Stats.SWORD_WPN_VULNERABILITY),
		...
		MAGIC(19, "Magic", null); // Костыль выбора оружия для ботов
	...
	public WeaponTemplate(StatsSet set)
	{
		...
		_atkRange = set.getInteger("atk_range", getDefaultAttackRange());
	 ...
	 */
	private int getDefaultAttackRange()
	{
		switch(getItemType())
		{
			case BOW:
