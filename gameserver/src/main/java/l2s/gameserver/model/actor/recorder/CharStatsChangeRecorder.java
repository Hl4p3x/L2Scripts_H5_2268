...
public class CharStatsChangeRecorder<T extends Creature>
{
	...
	protected void refreshStats()
	{
		...
		_abnormalEffects = set(BROADCAST_CHAR_INFO, _abnormalEffects, _activeChar.getAbnormalEffectMask());
		_abnormalEffects2 = set(BROADCAST_CHAR_INFO, _abnormalEffects2, _activeChar.getAbnormalEffectMask2());
		_abnormalEffects3 = set(BROADCAST_CHAR_INFO, _abnormalEffects3, _activeChar.getAbnormalEffectMask3());
